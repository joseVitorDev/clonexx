      ...
      <div className="relative flex flex-col md:flex-row flex-grow w-full">
        ...
        <main className="absolute inset-x-0 top-24 md:top-48 flex flex-col text-white text-center px-4 items-center">
          ...
          <div className="bg-red-700 text-white p-4 rounded-md text-xl font-bold w-full mt-6 flex items-center flex-col ">
             <Image src={Saque} className="w-20 h-20 mb-4" alt="Logo Pix" />
            SAQUE SOLICITADO!
          </div>
          <p className="mt-4 text-lg font-medium text-justify">
            Seu saque será efetuado em até <u><strong>15 dias úteis</strong></u>.
          </p>
          <p className="mt-4 text-lg font-medium text-justify">Caso deseje antecipar e receber <strong>Agora Mesmo</strong> em sua conta, pague a <u>Taxa de Antecipação</u> de R$ 28,16. <strong>Clique no botão abaixo!</strong></p>
        <Link href="https://pay.comprassite.com/checkout/9dc3cf66-5a93-4197-bc88-19eb20fb0f18" >
